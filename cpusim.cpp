...
int main(int argc, char* argv[])
{
	...
	*/
	...
	int a0=myCPU.Outputa0();
	int a1=myCPU.Outputa1();
 //   cout<< "Total number of R-type insturction is "<<myCPU.r_type_instructuin_count<<endl;
  //  cout<< "Total number of cycles is "<<myCPU.total_number_of_cycle_including_zero<<endl;
 //   cout<< "Total number of efficient cycles is "<<myCPU.efficient_instruction_count<<endl;
 //   cout<< "Instruction per cycle is "<<myCPU.IPC<<endl;
